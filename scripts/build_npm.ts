...
await build({
  ...
  package: {
    ...
    description: "Universal Liquid API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/liquid.git",
    },
    bugs: {
      url: "https://github.com/coinset/liquid/issues",
    },
    homepage: "https://github.com/coinset/liquid#readme",
    funding: {
      type: "patreon",
